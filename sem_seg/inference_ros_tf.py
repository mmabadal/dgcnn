...
class Pointcloud_Seg:
    ...
    def __init__(self, name):
        ...
        self.pub_pc_info_world = rospy.Publisher("/stereo_ch3/scaled_x4/points2_info_world", PointCloud2, queue_size=4)
    ...
    def run(self,_):
        ...
        left_frame_id = "girona500/stereo_down/left_optical"
